...
namespace cuda {
	...
	template <class _Mat, class _Vec, class _Mat2>
	inline void matrix_sub_vector(const _Mat& _Src1, const _Vec& _Src2, _Mat2& _Dst) {
		...
		_matrix_sub_vector<_T1, _T2>(_Src1.data(), _Src2.data(), _Dst.data(), N, M);
	}
}